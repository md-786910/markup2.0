  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[12px] text-gray-400">
              {pin.createdBy?.name || "Unknown"} &middot;{" "}
          ...
          <div className="flex items-center gap-0.5">
            ...
            <button
              onClick={() =>
                onStatusChange(
                  pin._id,
                  pin.status === "resolved" ? "pending" : "resolved",
                )
              }
                    ...
                    editingComment !== comment._id && (
                      <button
                        onClick={() => {
                          ...
                          setEditBody(stripHtmlForEdit(comment.body));
                        }}
      ...
      <form
        ...
        className="p-3 border-t border-gray-200 bg-gray-50 shrink-0"
      >
        <MentionInput
          ref={mentionRef}
          value={body}
        ...
        createPortal(
          ...
          >
            ...
            >
              ...
              />
              {lightbox.pin?.viewportXPercent != null &&
                lightbox.pin?.viewportYPercent != null && (
                  <div
