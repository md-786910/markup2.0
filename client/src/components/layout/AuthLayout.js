      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[540px] bg-gray-900 relative overflow-hidden">
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-white tracking-tight">MarkUp</span>
          </div>
          ...
          {/* Footer */}
          <p className="text-xs text-gray-600">&copy; {new Date().getFullYear()} MarkUp. All rights reserved.</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center gap-2.5 mb-10">
            ...
            <span className="text-lg font-bold text-gray-900 tracking-tight">MarkUp</span>
          </div>
          {children}
        </div>
      </div>
