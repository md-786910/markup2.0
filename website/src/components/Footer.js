...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-white/8 bg-[#0b1120] text-white">
      <div className="absolute left-0 top-0 h-72 w-72 rounded-full bg-[#3f4cf6]/16 blur-[120px]" />
        ...
        <div className="grid gap-10 lg:grid-cols-[1.3fr_repeat(3,minmax(0,1fr))]">
          <div className="max-w-sm">
            <a href="/" className="inline-flex items-center gap-3">
              <div className="grid h-10 w-10 place-items-center rounded-2xl bg-[#3f4cf6] text-white shadow-[0_18px_38px_rgba(63,76,246,0.26)]">
