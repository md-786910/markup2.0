    ...
    <section id="comparison" className="section-shell py-14 sm:py-14 px-10 sm:px-10" ref={ref}>
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center" data-reveal>
          <h4 className="text-[12px] mb-3 text-[#38BDF8] font-serif font-bold uppercase"><span className="font-extrabold">––</span> Comparison</h4>
        ...
        <div className="mx-auto mt-10 max-w-5xl overflow-x-auto rounded-[24px] border border-gray-200 bg-white shadow-sm" data-reveal data-delay="1">
          <div className="min-w-[620px]">
            <div className="grid grid-cols-3 border-b border-gray-200 bg-gray-50">
              <div className="px-6 py-4 leading-[1.7] max-w-[65ch] text-[#475569] font-sans">Feature</div>
              <div className="px-6 py-4 text-center leading-[1.7] max-w-[65ch] text-[#475569] font-sans font-semibold">
                <span className="font-display font-bold text-gradient">Markly</span>
              </div>
              <div className="px-6 py-4 text-center leading-[1.7] max-w-[65ch] text-[#475569] font-sans">Markup.io</div>
            </div>
            ...
            {COMPARISONS.map(([feature, feedbackly, competitor], i) => (
              ...
              >
                <div className="px-6 py-4 font-medium leading-[1.7] max-w-[65ch] text-[#475569] font-sans">{feature}</div>
