      ...
      <main>
        ...
        <section className="section-pad-tight">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* 1. Introduction */}
            <h2 id="introduction" className="font-display text-2xl font-bold text-[#10231f] mb-4">
              1. Introduction
            </h2>
            ...
            <h2 id="information-we-collect" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              2. Information We Collect
            </h2>
            ...
            <h2 id="how-we-use" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              3. How We Use Your Information
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            <h2 id="information-sharing" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
            ...
            {/* 5. Data Retention */}
            <h2 id="data-retention" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              5. Data Retention
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 6. Data Security */}
            <h2 id="data-security" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              6. Data Security
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 7. Your Rights */}
            <h2 id="your-rights" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              7. Your Rights
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            <h2 id="childrens-privacy" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              8. Children's Privacy
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            <h2 id="international-transfers" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              9. International Data Transfers
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
