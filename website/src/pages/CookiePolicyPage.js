        ...
        <section className="section-pad-tight">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <nav className="premium-card mb-12 p-6 sm:p-8">
              <h2 className="mb-4 font-display text-lg font-semibold text-gray-900">Table of Contents</h2>
              <ol className="list-decimal list-inside space-y-2">
                {SECTIONS.map((section) => (
                  <li key={section.id}>
                    <a href={`#${section.id}`} className="text-blue-600 underline hover:text-blue-700">
                      {section.title}
                    </a>
                  </li>
                ))}
            ...
            <h2 id="overview" className="mb-4 font-display text-2xl font-bold text-gray-900">
              1. Overview
            </h2>
            ...
            <h2 id="types" className="mb-4 mt-12 font-display text-2xl font-bold text-gray-900">
              2. Types of Cookies We Use
            </h2>

            <h3 className="mb-2 mt-6 font-display text-lg font-semibold text-gray-900">
            ...
            <h2 id="lawful-basis" className="mb-4 mt-12 font-display text-2xl font-bold text-gray-900">
            ...
            <h2 id="manage" className="mb-4 mt-12 font-display text-2xl font-bold text-gray-900">
            ...
            <ul className="mb-4 ml-4 list-disc list-inside space-y-2 text-gray-600">
            ...
            <h2 id="retention" className="mb-4 mt-12 font-display text-2xl font-bold text-gray-900">
            ...
            <h2 id="updates" className="mb-4 mt-12 font-display text-2xl font-bold text-gray-900">
            ...
            <h2 id="contact" className="mb-4 mt-12 font-display text-2xl font-bold text-gray-900">
              7. Contact Us
            </h2>
            <p className="mb-4 leading-relaxed text-gray-600">
