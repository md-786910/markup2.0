        ...
        <section className="section-pad-tight">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="premium-card mb-12 p-6 sm:p-8">
              <h2 className="font-display text-lg font-semibold text-[#10231f] mb-4">Table of Contents</h2>
              <ol className="list-decimal list-inside space-y-2">
                {SECTIONS.map((section) => (
                  <li key={section.id}>
                    <a
                      href={`#${section.id}`}
                      className="text-[#176b57] hover:text-[#0f5f4c] underline"
                    >
            ...
            <h2 id="acceptance" className="font-display text-2xl font-bold text-[#10231f] mb-4">
              1. Acceptance of Terms
            </h2>
            ...
            <h2 id="description" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              2. Description of Service
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 3. User Accounts */}
            <h2 id="user-accounts" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              3. User Accounts
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            <h2 id="acceptable-use" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              4. Acceptable Use Policy
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            <h2 id="intellectual-property" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              5. Intellectual Property
            </h2>
            ...
            <h2 id="guest-review-links" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              6. Guest Review Links
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 7. Payment Terms */}
            <h2 id="payment-terms" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              7. Payment Terms
            </h2>
            ...
            <h2 id="free-trial" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              8. Free Trial & Cancellation
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 9. Termination */}
            <h2 id="termination" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              9. Termination
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 10. Disclaimers */}
            <h2 id="disclaimers" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              10. Disclaimers
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            <h2 id="limitation-of-liability" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              11. Limitation of Liability
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 12. Indemnification */}
            <h2 id="indemnification" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              12. Indemnification
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 13. Governing Law */}
            <h2 id="governing-law" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
            ...
            {/* 14. Changes */}
            <h2 id="changes" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
            ...
            {/* 15. Severability */}
            <h2 id="severability" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              15. Severability
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
            ...
            {/* 16. Contact Us */}
            <h2 id="contact" className="font-display text-2xl font-bold text-[#10231f] mt-12 mb-4">
              16. Contact Us
            </h2>
            <p className="text-[#53645f] leading-relaxed mb-4">
